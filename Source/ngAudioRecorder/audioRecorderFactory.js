tenorrecorderService.factory('recorderInitializerFactory', ['$http', 'recorderFactory', function ($http, recorderFactory) {
    ...
    var doneEncoding = function (blob) {
        recorderFactory.SetupDownload(blob, "myRecording" + ((recIndex < 10) ? "0" : "") + recIndex + ".wav");
        recIndex++;
    };
